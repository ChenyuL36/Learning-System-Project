...
router.get("/course/instructor/:_instructor_id", (req, res) => {
...
router.get("/course/findByName/:name", (req, res) => {
  let { name } = req.params;
...
router.get("/course/student/:_student_id", (req, res) => {
...
router.post("/course/enroll/:_id", async (req, res) => {
  let { _id } = req.params;
